      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    <label for="inputEvent">Date</label>
                    <input type="date" value="" class="form-control" name="eventDate" />
                  </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-lg-6 col-md-6 form-group">
                ...
                <input type="text" class="form-control" name="eventDetails" placeholder="Describe the event/workshop/seminar here" />
              </div>
            </div>
